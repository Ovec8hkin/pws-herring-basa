...
# Sigma for mean age 0 to allow for shrinkage (ph_sigmaage0)
-2
...
# Aerial age-1 survey scalar coefficient & overdispersion parameters (ph_hyd2)
2

# Annual infection & recovery probabilities (ph_vhs_pars)
3

# Parameters for logistic function describing proportions mixing with sympatric population for transmission (ph_vul_symp)
3

# Parameters for logistic function describing proportions vulnerable to surveys for seroprevalence samples (ph_vul_sero)
-3
